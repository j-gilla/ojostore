...
var simpleStore = {
    ...
    notifier: function (a) {
        s = this.settings;
        var b = $("#notify-template").html(),
            c = $(b);
        a.length && (c.find(".notify_text").text(a), s.container.append(c), c.hide(), c.fadeIn(s.fadeSpeed), setTimeout(function () {
            c.fadeOut(s.fadeSpeed)
        }, 1e3))
    },
    initJSON: function (a) {
